...
//        pPoseStack.popPose();
        ...
        if (itemHeld.getItem() == ItemManager.MOB_SHARD.get()) {
            ...
            if (nbtTag != null && nbtTag.getInt(NbtTagsName.KILLED_COUNT) == MobShard.KILL_NEEDED) {
                ...
                renderGivenEntity(type, pBlockEntity, pPoseStack, pBufferSource);
            }
        }
    }
     ...
     * @param pBufferSource
     */
    public void renderGivenEntity(EntityType entityType, IronMobFarmEntity pBlockEntity, PoseStack pPoseStack, MultiBufferSource pBufferSource) {
